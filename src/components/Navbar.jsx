...
// import { ChevronDown, Settings, LogOut, IndianRupee, X } from "lucide-react";
// import logo from "../assets/dvyb_logo.svg";
...
//       {/* Navbar */}
//       <nav
//         className="px-4 lg:px-6 py-4 shadow-sm relative z-50"
//         style={{
//           background:
//             "linear-gradient(90.23deg, #61C2FF 2.31%, #FFFFFF 152.12%)",
//         }}
//       >
...
// <button
//   className="cursor-pointer transition-colors duration-200 p-2 rounded-full hover:bg-blue-500"
...
//               {isNotificationOpen && (
//                 <div className="absolute right-0 mt-3 w-80 bg-white backdrop-blur-lg rounded-2xl shadow-xl p-6 text-center z-50">
//                   {/* Arrow */}
//                   <div className="absolute -top-2 right-5 w-4 h-4 bg-white rotate-45 shadow-md"></div>
...
//                     <button className="flex items-center gap-2 px-4 py-3 text-blue-400 hover:bg-blue-50 rounded-t-xl">
//                       <Settings size={18} /> <span>Settings</span>
//                     </button>
//                     <button className="flex items-center gap-2 px-4 py-3 text-blue-400 hover:bg-blue-50">
//                       <LogOut size={18} /> <span>Logout</span>
//                     </button>
//                     <button className="flex items-center gap-2 px-4 py-3 text-blue-400 hover:bg-blue-50 rounded-b-xl">
//                       <IndianRupee size={18} /> <span>Commission</span>
//                     </button>
//                   </div>
//                 </div>
//               )}
...
//                 {isCategoriesOpen && (
//                   <div
//                     className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 bg-white rounded-lg shadow-xl border border-gray-100 z-50 overflow-hidden"
...
//                             <div
//                               className="w-20 h-20 rounded-full mb-3 flex items-center justify-center overflow-hidden group-hover:scale-105 transition-transform duration-200 shadow-md"
//                               style={{
